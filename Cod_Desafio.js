...
function registarVenda(Produtos, listaLancamentos) {
    ...
    var codDese = parseInt(prompt("Digite o código do produto que deseja vender:"));
...
var listaLancamentos = [
    { quantidade: 2, descricao: produtos1.descricao, total: produtos1.preco},
